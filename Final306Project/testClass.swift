...
//  Created by Paolo Garcia & Alex Hansen on 3/21/17.
...
class TestClass: UIViewController {
    ...
    let task = URLSession.shared.dataTask(with: request as URLRequest) {
      ...
      /*              let location = LocationModel()
                    ...
                    //if no nil values
                    if let custID1 = jsonElement["customer_id"] as? String, let roomName1 = jsonElement["room_name"] as? String, let roomID1 = jsonElement["room_id"] as? String, let compName1 = jsonElement["component_name"] as? String, let compStatus1 = jsonElement["component_status"] as? gString {
